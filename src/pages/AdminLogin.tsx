        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="px-8 py-8 space-y-6">
            ...
            <div className="flex items-center">
              <input type="checkbox" id="remember" className="w-4 h-4 rounded border-gray-300 text-orange-500" disabled={isLoading} />
          ...
          <div className="px-8 py-6 bg-gray-50 border-t border-gray-200">
            ...
            <div className="space-y-2 text-xs">
              <p className="text-gray-700">Email: <span className="font-mono font-bold text-orange-600">admin@example.com</span></p>
              <p className="text-gray-700">Password: <span className="font-mono font-bold text-orange-600">password</span></p>
            </div>
          </div>
        </div>

        <p className="text-center text-gray-400 text-xs mt-6">© 2025 Admin Dashboard. All rights reserved.</p>
      </div>
    </div>
  )
}
